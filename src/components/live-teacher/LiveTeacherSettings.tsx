        ...
        >
          ...
          <Card className="p-4 bg-primary/10 border-primary/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-primary">Afaan Oromoo Qofa</h3>
                <p className="text-sm text-muted-foreground">
                  AI kun afaan kamiin illee hubata, garuu Afaan Oromootiin qofa deebisa
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Enable voice-to-voice conversation with Gemini Live API
                </p>
              </div>
              <Switch
                checked={settings.realtime_audio}
          ...
          <Card className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Automatically speak AI responses in Oromo
                </p>
              </div>
              <Switch
