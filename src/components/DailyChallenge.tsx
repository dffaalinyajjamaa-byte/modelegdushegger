  ...
  return <Card className="glass-card">
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          return <Card key={challenge.id} className={`overflow-hidden transition-all border-2 ${completed ? 'bg-primary/10 border-primary/50' : `bg-gradient-to-br ${colorClass}`}`}>
                <div className="p-4">
                  <div className="flex items-start gap-3">
                    {/* Icon */}
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${completed ? 'bg-primary/20' : 'bg-background/50'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {challenge.description && <p className="text-xs text-muted-foreground line-clamp-2">
