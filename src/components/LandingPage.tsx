...
export default function LandingPage({
  ...
  return <div className="min-h-screen w-full overflow-y-auto overflow-x-hidden">
      <BackgroundPaths title="Model Egdu" onButtonClick={onGetStarted} showButton={true}>
        ...
        <div className="relative z-10 py-20">
          <div className="container mx-auto px-4">
            ...
            delay: 0.5
              ...
              <img src={logo} alt="Model Egdu" className="w-32 h-32 md:w-40 md:h-40 rounded-full shadow-2xl border-4 border-red-500 mb-4" />
                  ...
                  <div className="flex-1 relative bg-gradient-to-br from-red-500/20 via-black to-red-900/30 flex flex-col items-center justify-center overflow-hidden p-6">
                    ...
                    <div className="relative w-full h-48 md:h-56 mb-4 rounded-xl overflow-hidden">
                      <AnimatePresence mode="wait">
                        <motion.img key={currentImageIndex} src={classroomImages[currentImageIndex]} alt="Classroom" className="absolute inset-0 w-full h-full object-cover rounded-xl" initial={{
                        opacity: 0,
                        scale: 1.1
                      }} animate={{
                        opacity: 1,
                      ...
                      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-2">
                        {classroomImages.map((_, idx) => <div key={idx} className={`w-2 h-2 rounded-full transition-all ${idx === currentImageIndex ? 'bg-red-500 w-4' : 'bg-white/50'}`} />)}
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            <ContainerScroll titleComponent={<>
              ...
              duration: 0.8
                    ...
                    <img src={logo} alt="Model Egdu" className="w-32 h-32 md:w-40 md:h-40 rounded-full shadow-2xl border-4 border-primary" />
                  </motion.div>
              ...
              <div className="w-full h-full bg-gradient-to-br from-red-500/20 via-white/10 to-black/20 rounded-2xl flex items-center justify-center p-8">
                <AnimatePresence mode="wait">
                  ...
                  duration: 0.5
                }} className="text-2xl md:text-4xl font-bold text-center text-popover-foreground font-sans">
                    {morphingTexts[currentTextIndex]}
                  </motion.p>
                </AnimatePresence>
              </div>
